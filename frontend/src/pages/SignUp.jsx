...
export default function Signup() {
  ...
  const [errorMessage , setErrorMessage] = useState(null); //this is for set the error messages 
  const [loading, setLoading] = useState(false); // this is for set the loading screen 
      ...
      <div className="flex p-3 max-w-3xl mx-auto flex-col md:flex-row md:items-center gap-5">
        ...
        <div className="flex-1">
          <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            <div >
              <Label value="Youer User Name" />
              <TextInput type="text" placeholder="Username" id="username" onChange={handleChange} />
            </div>
            <div >
              <Label value="Youer Email" />
